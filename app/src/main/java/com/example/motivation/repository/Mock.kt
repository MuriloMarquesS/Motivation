...
class Mock  {
    ...
    private var ALL = MotivationConstants.FILTERPHRASE.ALL
    private var HAPPY = MotivationConstants.FILTERPHRASE.HAPPY
    private var MORNING = MotivationConstants.FILTERPHRASE.MORNING
